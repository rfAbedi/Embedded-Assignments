###########################################################################
## Makefile generated for component 'ex5_StateChart1'. 
## 
## Makefile     : ex5_StateChart1.mk
## Generated on : Fri Dec 27 20:27:50 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ex5_StateChart1.elf
...
PRODUCT_NAME              = ex5_StateChart1
MAKEFILE                  = ex5_StateChart1.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/erfuu/OneDrive/Courses/EMBEDD~1/EXERCI~1/ex4
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ex5_StateChart1.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/ex5_StateChart1_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/cores/arduino -I$(ARDUINO_AVR_ROOT)/hardware/avr/$(AVR_LIB_VERSION)/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~2/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2024a/toolbox/target/SUPPOR~1/ARDUIN~1/include -I$(ARDUINO_AVR_ROOT)/tools/avr-gcc/$(AVR_GCC_LIB_VERSION)/avr/include
...
DEFINES_STANDARD = -DMODEL=ex5_StateChart1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = ex5_StateChart1.o ex5_StateChart1_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/ex5_StateChart1_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ex5_StateChart1_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ex5_StateChart1_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/ex5_StateChart1_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ex5_StateChart1.o : $(START_DIR)/ex5_StateChart1_ert_rtw/ex5_StateChart1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ex5_StateChart1_data.o : $(START_DIR)/ex5_StateChart1_ert_rtw/ex5_StateChart1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
