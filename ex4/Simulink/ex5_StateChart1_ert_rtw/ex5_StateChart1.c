...
void ex5_StateChart1_step(void)
{
  ...
  if (ex5_StateChart1_DW.is_active_c2_ex5_StateChart1 == 0U) {
    ...
    if (ex5_StateChart1_DW.ctr_dc < tmp) {
       ...
       *  Sum: '<S1>/Sum1'
       */
      ex5_StateChart1_Y.dc_speed = (((ex5_StateChart1_U.temp_adc -
        ex5_StateChart1_P.Constant_Value) * ex5_StateChart1_P.Gain_Gain +
        ex5_StateChart1_P.Constant1_Value) - 20.0) *
        ex5_StateChart1_DC_MAX_SPEED / 275.5;
